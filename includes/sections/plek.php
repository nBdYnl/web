...
?>
<section class="plek" id="plek">
  <div class="plek-grid">
    <div class="plek-text">
      <div class="label" <?= !$hasDbData ? 'data-t="plek_label"' : '' ?>><?= $hasDbData ? sanitizeInput($title) : 'Onze droom' ?></div>
      ...
      <p <?= !$hasDbData ? 'data-t="plek_desc2"' : '' ?>><?= $hasDbData ? sanitizeInput($desc2) : 'Geen therapie, geen programma. Gewoon zijn. Samen rond het vuur. Praten als je wilt, zwijgen als je moet. Een plek waar zielen mogen rusten, mogen praten, mogen verbinden. Dat is waar we naartoe werken.' ?></p>
